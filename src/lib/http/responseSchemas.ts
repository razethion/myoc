...
export const AdminJobNameSchema = z.enum(['d1-backup', 'r2-media-cleanup'])
...
export const AdminJobSummarySchema = z.union([D1BackupSummarySchema, R2CleanupSummarySchema])
