...
const PRODUCT_VISION_POINTS = [
    {
        ...
        body: 'Character profiles should make accessing artwork quick, easy, and simple. The product should be so' +
    ...
    },
    {
        ...
        body: 'Character owners should be able to maintain their characater gallery easily and intuitively. The UX should' +
    ...
    },
    {
        ...
        body: 'People should be able to rely on the product as a representative gallery, without worrying about their ' +
    ...
    },
    {
        ...
        body: 'Extra features are nice, but should not take away from any other product goals, and ideally they' +
        ...
        <BaseLayout title="Product Vision | MyOC">
            ...
            <main class="min-h-[calc(100vh-4rem)] bg-base-100 px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                <section class="mx-auto max-w-6xl">
                    ...
                    <section
                        class="grid gap-8 border-b border-base-content/10 py-10">
                        <div>
                            <h2 class="font-display mt-3 text-3xl leading-tight">I've been in your shoes.</h2>
                            <p class="mt-3">
                                Maybe you use another gallery site like toyhou.se, or maybe you keep all your
                                character photos in a photo gallery like google photos, or maybe you keep your art in
                                a cloud storage provider like Google Drive or Dropbox.
                            </p>
                            <p class="mt-3">
                                Those solutions might work, but they all have their own issues.
                            </p>
                            <p class="mt-3">
                                Toyhou.se is focused on dozens of features, character trading, lore, CSS, etc. It's no
                                doubt a powerful platform, but not everybody wants that kind of featureset, and it
                                can be hard for somebody that doesn't understand toyhou.se to browse a heavily
                                customized
                                CSS profile.
                            </p>
                            <p class="mt-3">
                                Google Photos is usable with albums, but those images aren't perfectly lossless, and
                                sharing albums isn't the most straight-forward process either.
                            </p>
                            <p class="mt-3">
                                Cloud storage providers are usable, but aren't designed to display your art the way
                                it deserves to be. Plus, many of them badger you into making an account just to view
                                the media in full resolution.
                            </p>
                            <h2 class="font-display mt-3 text-3xl leading-tight">It shouldn't be this hard.</h2>
                            <p class="mt-3">
                                MyOC was born out of the desire to <i>just show people my character art</i>. I stood up
                                a super basic gallery site just for myself so I could send a simple link to artists when
                                I bought commissions, and it was perfect. I liked it so much that I turned it into
                                a product anybody can use...and you're looking at it.
                            </p>
                        </div>
                    </section>
                                ...
                                {PRODUCT_VISION_IS_NOT.map((item) => (
                                    <li class="flex gap-3">
                                        <span aria-hidden="true"
                                              class="mt-2 h-1.5 w-1.5 shrink-0 bg-base-content/35"></span>
                                        <span>{item}</span>
                                    </li>
                                ))}
                            </ul>
